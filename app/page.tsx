...
export default function Home() {
  ...
  return (
    <main className="bg-main_color h-screen px-10 py-10">
      ...
      {/* MOBILE NAVBAR */}
      <div className='max-md:flex md:hidden mb-4 justify-end items-center gap-4'>
        <form className="w-3/5 ">   
            ...
            <div className="relative">
                ...
                <input type="search" id="default-search" className="block w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 " placeholder="Search Dress..." required />
                <button type="submit" className="text-white absolute end-2.5 bottom-1 bg-highlight_color font-medium rounded-lg text-sm px-2 py-1">Search</button>
            </div>
        </form>
      ...
      <div className="flex flex-col w-full justify-center items-center relative h-20">
        <h1 className="text-5xl font-bold font-perandory text-highlight_color">ETHEREAL</h1>
        <p className=" absolute font-amoresa text-3xl font-semibold text-highlight_color bottom-0">muse</p>
      </div>
    </main>
  )
}